        ...
        <div class="w3_info">
          ...
          <el-card shadow="always" class="card">
            <el-tabs v-model="activeName">
              <el-tab-pane label="وارد شوید" name="first" stretch>
                <span slot="label"><span style="margin: 30px">وارد شوید</span></span>
                <br/>
                <el-form
                  ref="loginForm"
                  label-position="top"
                ...
                >
                  ...
                  <el-form-item
                    prop="captcha"
                    v-if="captchaState"
                    :rules="{required: true,message: 'لطفا کد تایپد را وارد کنید',trigger: 'blur'}"
                  >
                    <el-input
                      type="text"
